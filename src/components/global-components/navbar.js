				  ...
				  <li>
			        ...
			        <li className="menu-item-has-children">
			          ...
			          <ul className="sub-menu">
						...
						*/}
			            <li><Link to="/tour-details">Apartment 2+1 with terrace</Link></li>
						<li><Link to="/tour-details">Apartment 2+1 first floor</Link></li>
			            <li><Link to="/tour-details">Apartment 2+2 with garden view</Link></li>
			            <li><Link to="/tour-details">Apartment 2+2 with sea view</Link></li>
						<li><Link to="/tour-details">Apartment 2+2 classic</Link></li>	
			          </ul>
			        </li>
			        <li>
